...
VERSION = "1.6.9"
                                                                     # ⚠️ 알림 문구에 「 」
# 를 쓰지 말 것. 폰트 아틀라스에 없어서 인게임에 **물음표로 찍힌다**(1.6.9 에서 실제로
# 겪음: "새 ?사격 훈련? 탭"). 코드베이스 관례대로 '작은따옴표' 를 쓴다.
# · — 는 폰트에 있으니 써도 된다.
NOTES = (
    "새 '사격 훈련' 탭 — 게임 안에서 실제로 조준하고 쏘면서 에임을 연습해요\n"
    "난이도 4단계와 10·30·60초 판, 난이도별 리더보드가 있어요\n"
    "설정 탭에서 커스텀 사진 배경이 어떤 기능인지 미리 볼 수 있어요"
)
# ───────────────────────────────────────────────────────────────────────────
