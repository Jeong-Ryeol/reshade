...
static_assert(
	reshade::input::key_button_left == VK_LBUTTON &&
	reshade::input::key_button_right == VK_RBUTTON &&
	reshade::input::key_button_middle == VK_MBUTTON &&
	reshade::input::key_button_xbutton1 == VK_XBUTTON1 &&
	reshade::input::key_button_xbutton2 == VK_XBUTTON2 &&
	reshade::input::key_ctrl == VK_CONTROL &&
	reshade::input::key_left_ctrl == VK_LCONTROL &&
	reshade::input::key_right_ctrl == VK_RCONTROL &&
	reshade::input::key_shift == VK_SHIFT &&
	reshade::input::key_left_shift == VK_LSHIFT &&
	reshade::input::key_right_shift == VK_RSHIFT &&
	reshade::input::key_alt == VK_MENU &&
