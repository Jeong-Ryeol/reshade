...
namespace sherbet
{
	...
	static const theme s_themes[] = {
		...
		// 심플 다크 — 그라디언트 없이 흑/회/백만. 배경 3스톱 동일값으로 완전 평면,
		// 강조도 단색(흰끼 도는 라이트그레이)으로 통일. 장식 최소화한 미니멀 다크모드.
		{ "darksimple", "Dark Simple",
			IM_COL32(0x12,0x12,0x12,255), IM_COL32(0x12,0x12,0x12,255), IM_COL32(0x12,0x12,0x12,255),
			IM_COL32(0x1c,0x1c,0x1c,214), IM_COL32(0x24,0x24,0x24,230),
			IM_COL32(0x2b,0x2b,0x2b,255), IM_COL32(0x3a,0x3a,0x3a,255),
			IM_COL32(0xf2,0xf2,0xf2,255), IM_COL32(0x8c,0x8c,0x8c,255),
			IM_COL32(0xd8,0xd8,0xd8,255), IM_COL32(0xd8,0xd8,0xd8,255),
			IM_COL32(0xff,0xff,0xff,40), particle::spark, false },
		// 밝은(라이트) 테마 — 흰우유에 딸기 하나. 배경은 밀크 화이트, 포인트는 딸기 핑크,
		// 대비를 위해 텍스트는 어두운 베리색으로 잡는다(다른 테마와 반대).
		{ "strawberry", "Strawberry Milk",
			IM_COL32(0xff,0xdf,0xe9,255), IM_COL32(0xff,0xf4,0xf7,255), IM_COL32(0xff,0xe9,0xf0,255),
			IM_COL32(0xff,0xff,0xff,180), IM_COL32(0xff,0xe0,0xea,214),
			IM_COL32(0xff,0xd3,0xe0,255), IM_COL32(0xff,0x8f,0xb3,96),
			IM_COL32(0x6a,0x28,0x3c,255), IM_COL32(0xb2,0x74,0x8a,255),
			IM_COL32(0xff,0x5d,0x8f,255), IM_COL32(0xff,0xa5,0xc4,255),
			IM_COL32(0xff,0x8f,0xb3,92), particle::heart, false },
	};
